  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today:
          "border border-teal-500 text-teal-600 dark:border-teal-400 dark:text-teal-200",
        day_outside: "text-gray-300 dark:text-gray-600",
        day_disabled: "text-gray-300 opacity-50 dark:text-gray-600",
        day_range_middle:
          "aria-selected:bg-teal-50 aria-selected:text-gray-900 dark:aria-selected:bg-teal-900/30 dark:aria-selected:text-teal-100",
