            ...
            {open && !loading && !error && (
                <div className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg">
                    ...
                    <div className="flex justify-between items-center px-3 py-1.5 border-b border-gray-100 dark:border-gray-700 text-xs">
                        ...
                        <button onClick={() => setOpen(false)} className="text-teal-600 hover:text-teal-700 font-medium px-2.5 py-1 rounded-md bg-teal-50 hover:bg-teal-100 dark:text-teal-400 dark:bg-teal-900/30 dark:hover:bg-teal-900/50 transition-colors">ตกลง</button>
                    </div>
                    ...
                    <div className="max-h-60 overflow-y-auto py-1">
                        {tabs.map((t) => (
                            <button key={t.sheetId} type="button" onClick={() => { onChange(t.title); setOpen(false); }}
                                className={cn("flex w-full items-center px-3 py-1.5 text-left text-sm hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer", t.title === value && "bg-primary/10 text-primary dark:bg-primary/40 dark:text-teal-100")}>
...
export function ExportAdsTab() {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            ...
            {/* Info Banner */}
            <div className="flex items-start gap-2.5 p-3 bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800 rounded-xl">
