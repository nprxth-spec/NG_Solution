...
export default function ConnectPage() {
  ...
  if (loginProvider === "google" || (hasGoogle && !hasFacebook)) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center p-4">
