    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href="/centxo/ads?tab=export">
            <Button size="sm" className="gap-2 bg-teal-600 hover:bg-teal-700 text-white border-teal-600 shadow-sm transition-colors font-medium">
